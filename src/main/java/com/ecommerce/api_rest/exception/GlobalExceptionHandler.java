...
import com.ecommerce.api_rest.model.payload.ApiResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(MethodArgumentNotValidException.class)            //ESTO ESTÁ EN CASO DE QUE SE IMPLEMENTEN VALIDACIONES EN LOS DATOS DE LAS ENTIDADES
